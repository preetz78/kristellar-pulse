...
import { TrendingUp, Briefcase, CheckCircle, Clock, ChevronDown } from "lucide-react";
...
const EmployeeDashboard = () => {
  ...
  // 🔥 ADVANCED PROGRESS CHART BUILDER (Same as Admin/Manager)
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
        ...
        >
          ...
          <p className="text-sm text-emerald-600 mt-6 flex items-center gap-1 font-medium">
            <TrendingUp size={16} /> Projects assigned to you
          </p>
        </div>
        ...
        >
          ...
          <p className="text-sm text-emerald-600 mt-6 flex items-center gap-1 font-medium">
            <TrendingUp size={16} /> Successfully completed tasks
          </p>
        </div>
      </div>
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="relative inline-flex">
              <select
                ...
                className="appearance-none bg-white border border-blue-200 text-sm px-5 py-2.5 rounded-2xl pr-10 focus:outline-none focus:ring-0 focus:border-blue-300 font-medium"
              >
