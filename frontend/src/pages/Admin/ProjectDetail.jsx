...
const ProjectDetail = () => {
            ...
            {tasks.map((task) => {
              ...
              return (
                <div
                  ...
                  className=" bg-white border border-slate-200 rounded-2xl p-5 hover:border-blue-300 hover:shadow-md transition-all group cursor-pointer
                  "
                >
            ...
            <form onSubmit={handleAddOrUpdateTask} className="p-8 space-y-6">
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full px-5 py-3.5 border border-gray-300 rounded-2xl focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 required" 
                />
              </div>
  ...
  >
    ...
    >
      ...
      <div
        className=" p-6 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 sticky top-0 z-10 shadow-lg text-white"
      >
